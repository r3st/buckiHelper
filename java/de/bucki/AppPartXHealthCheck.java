...
@Liveness
@ApplicationScoped
public class AppPartXHealthCheck implements HealthCheck {
    private static boolean up = true;
    private static HashMap<String, String> strData = new HashMap<String, String>();

    static {
        strData.put("x1", "1000");
        strData.put("x2", "foobar");
    }

    @Override
    public HealthCheckResponse call() {
        HealthCheckResponseBuilder responseBuilder = HealthCheckResponse.named("app part x");
